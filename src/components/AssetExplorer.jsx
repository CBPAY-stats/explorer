  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            XDB Chain Asset Explorer
          </CardTitle>
          <CardDescription>
            Explore all assets issued on the XDB Chain network
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <div className="flex-1">
              <Input
                placeholder="Asset code (e.g., USD, EUR, BTC)"
                value={searchCode}
            ...
            <div className="flex-1">
              <Input
                placeholder="Issuer address (optional)"
                value={searchIssuer}
      ...
      {loading && assets.length === 0 ? (
        ...
        <Card>
          <CardHeader>
            <CardTitle>Assets Found ({assets.length})</CardTitle>
            <CardDescription>
              List of assets on the XDB Chain network
            </CardDescription>
          </CardHeader>
          <CardContent>
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {asset.num_claimable_balances > 0 && (
                              <span>+{asset.num_claimable_balances} claimable</span>
                            )}
                          </div>
                        </div>
                      </TableCell>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Try searching for a specific asset code or leave it blank to see all assets.
            </p>
